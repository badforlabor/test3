...
TSharedPtr< FSlateStyleSet > FMyPluginStyle::StyleInstance = NULL;
...
{
	TSharedRef< FSlateStyleSet > Style = MakeShareable(new FSlateStyleSet("MyPluginStyle"));
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("MyPlugin")->GetBaseDir() / TEXT("Resources"));

	Style->Set("MyPlugin.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
...
void FMyPluginStyle::ReloadTextures()
{
